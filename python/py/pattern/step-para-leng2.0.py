...
#        print()
    ...
    if(ba_data == 0) :
        ...
        return pattern_dict, sum_dict
    else :
        return 0
                


def inspect(file_name1, file_name2, time_leng, pattern_leng, top_print) : 
    #ファイル1のデータカウント
#        print(sig1[len(psth)-1])
    pattern_dict1 = {}
    pattern_dict1 = import_file(file_name1, pattern_dict1, 0, time_leng, pattern_leng)
...
#        print_probability2[k] = (pattern_dict2[i]+1 / sum_pattern2)
 ...
 #   print(print_pattern)
    ...
    fig = plt.figure(dpi=600)
    ax = fig.gca()
    plt.bar(print_pattern, print_kullback, color="red", label="equation item of kullback")
