...
#f = open('sys.argv[2]','w')
print("accuracy:{:.4f} $\\pm$ {:.4f}".format(accuracy.mean(axis=0), accuracy.std(axis=0)))
...
print('      実&ベース波形 & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \cline{{2-8}}' 
...
print('      際& リップル波形 & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \cline{{2-8}}' 
...
print('      の& ノイズ & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \cline{{2-8}}' 
...
print('      分& リップル・ベース & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \cline{{2-8}}' 
...
print('      類& ノイズ・ベース & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \cline{{2-8}}' 
...
print('      & リップル・ノイズ & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f} & {:.3f}  \\\\ \hline' 
