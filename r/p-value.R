...
#install.packages("gplots")
#library(gplots)
#plotmeans(x=list(datarestraintbase[,3],datarestraint10[,3],datarestraint30[,3]), data=x, connect=F, ylim=c(-180,180))

#plotmeans(x=list(datarestraintbase[,3],datarestraint10[,3],datarestraint30[,3]))
